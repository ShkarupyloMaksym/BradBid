...
\begin{enumerate}
    ...
    \item Варіант 1 (Простий): Matcher Lambda пише JSON безпосередньо у Firehose $\to$ S3.
    \item Варіант 2 (Дешевий): EventBridge Pipe читає \texttt{trades.fifo} $\to$ записує в S3 (або через Lambda).
